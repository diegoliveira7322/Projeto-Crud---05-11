...
<body>
    <section class="vh-100">
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="jumbotron">
                    <div class="row">
                        <h2>Aula de pbe - David <span class="badge text-bg-secondary">v 1.0.0 - SENAIF</span>
                        </h2>
                    </div>
    ...
    <div
        class="d-flex flex-column flex-mf-row text-center text-md-start justify-content=between py-4 px-4 px-xl-5 bg-primary">
        <div class="text-white mb-3 mb-mf-0">
